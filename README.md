...
Tag your n8n workflows with `openai-model` (configurable) and they are automatically discovered and exposed as models. Polling interval can be configured (default: 300 seconds).
